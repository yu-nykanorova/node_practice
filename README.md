...
### Branch
`lessons/lesson10-s3-presenters`
...
- File upload functionality to S3 bucket
- File URL generation and storage in user entity
- Implementation of presenters for response formatting
