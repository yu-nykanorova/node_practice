...
### Topic
Email verification flow after user registration

### What was implemented
- Generation of verification action token during sign up
- Verify email endpoint implementation
- Changing user status isVerified in DB after successful verification
