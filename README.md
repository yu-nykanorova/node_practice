...
- Sending password reset email with action token
- Generating and storing forgot password action tokens
- Reset password endpoint with token validation
- Password update logic with hashing
- Invalidating old tokens after password reset
